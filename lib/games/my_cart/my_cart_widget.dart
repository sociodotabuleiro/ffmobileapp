...
class _MyCartWidgetState extends State<MyCartWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'myCart'});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('MY_CART_arrow_back_rounded_ICN_ON_TAP');
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'MY_CART_TextField_5pxp45xx_ON_TEXTFIELD_');
                                      logFirebaseEvent(
