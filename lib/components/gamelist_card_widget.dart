                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          formatNumber(
                            containerGamesRecord.averagePrice,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          containerGamesRecord.rating.toString(),
                          style: FlutterFlowTheme.of(context)
                              .labelMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                8.0, 0.0, 0.0, 0.0),
                            child: Text(
                              containerGamesRecord.playerCount,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                8.0, 0.0, 0.0, 0.0),
                            child: Text(
                              '${containerGamesRecord.ageRecommendation} anos',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
