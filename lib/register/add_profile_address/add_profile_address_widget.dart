...
class _AddProfileAddressWidgetState extends State<AddProfileAddressWidget> {
  ...
  void initState() {
    ...
    _model.neighboorhoodTextController ??= TextEditingController();
    _model.neighboorhoodFocusNode ??= FocusNode();
    _model.neighboorhoodFocusNode!.addListener(() => setState(() {}));
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.streetFocusNode?.hasFocus ??
                                                  false)
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.numberFocusNode?.hasFocus ??
                                                  false)
                                              ? const Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.neighboorhoodTextController,
                                    focusNode: _model.neighboorhoodFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.neighboorhoodFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? const Color(0x4D9489F5)
                                          : Colors.white,
                                    ...
                                    cursorColor: const Color(0xFF6F61EF),
                                    validator: _model
                                        .neighboorhoodTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                    controller:
                                        _model.referencePointTextController,
                                    focusNode: _model.referencePointFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.referencePointFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? const Color(0x4D9489F5)
                                          : Colors.white,
                                  ...
                                  TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      _model.apiResult =
                                          await GetCEPInfoCall.call(
                                        cep: _model.zipCodeTextController.text,
                                      );
                                      if ((_model.apiResult?.succeeded ??
                                          true)) {
                                        setState(() {
                                          _model.cityTextController?.text =
                                              GetCEPInfoCall.cidade(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.zipCodeFocusNode?.hasFocus ??
                                                  false)
                                              ? const Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                        ...
                        await currentUserReference!
                          ...
                          address: updateAddressStruct(
                            AddressStruct(
                              ...
                              complement: _model.complementTextController.text,
                              neighborhood:
                                  _model.neighboorhoodTextController.text,
                              closeReferencePoint:
