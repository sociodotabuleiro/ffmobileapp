                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '${_model.address?.street}, ${_model.address?.number}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                  ...
                                                  Text(
                                                    '${_model.address?.city}, ${_model.address?.state} - ${_model.address?.zip}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'SETTINGS_LIST_ADDRESS_editAddress_ON_TAP');
                                                      logFirebaseEvent(
                                                          'editAddress_bottom_sheet');
