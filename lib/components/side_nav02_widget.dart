...
class SideNav02Widget extends StatefulWidget {
  const SideNav02Widget({super.key});

  @override
  State<SideNav02Widget> createState() => _SideNav02WidgetState();
}
                ...
                children: [
                      ...
                      builder: (context) => AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: valueOrDefault<Color>(
                            (currentUserDocument?.notificacoes.toList() ?? []).isNotEmpty
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                color: (currentUserDocument?.notificacoes
                                                    .toList() ??
                                                []).isNotEmpty
                                        ...
                                        .override(
                                          fontFamily:
                                              FlutterFlowTheme.of(context)
                                                  .bodyMediumFamily,
                                          color: valueOrDefault<Color>(
                                            (currentUserDocument?.notificacoes
                                                                .toList() ??
                                                            []).isNotEmpty
                                                ? FlutterFlowTheme.of(context)
                                                    .info
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SIDE_NAV02_COMP_Row_e0721iwm_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'SIDE_NAV02_COMP_contentView_1_ON_TAP');
                        logFirebaseEvent('contentView_1_navigate_to');

                        context.pushNamed('gameListAdmin');
                      },
                      child: AnimatedContainer(
                        duration: const Duration(milliseconds: 200),
                        curve: Curves.easeInOut,
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SIDE_NAV02_COMP_Row_tjfhgcer_ON_TAP');
                              logFirebaseEvent('Row_navigate_to');
                      ...
                      children: [
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SIDE_NAV02_modoClaroContainer_ON_TAP');
                              logFirebaseEvent(
                                  'modoClaroContainer_set_dark_mode_setting');
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SIDE_NAV02_ModoEscuroContainer_ON_TAP');
                              logFirebaseEvent(
                                  'ModoEscuroContainer_set_dark_mode_settin');
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('SIDE_NAV02_COMP_Icon_3mcei3ee_ON_TAP');
