...
class AddProfilePersonalInfoWidget extends StatefulWidget {
  const AddProfilePersonalInfoWidget({
    super.key,
  ...
  @override
  State<AddProfilePersonalInfoWidget> createState() =>
      _AddProfilePersonalInfoWidgetState();
}

class _AddProfilePersonalInfoWidgetState
    extends State<AddProfilePersonalInfoWidget> {
  late AddProfilePersonalInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProfilePersonalInfoModel());
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    fillColor:
                                        (_model.cpfFocusNode?.hasFocus ?? false)
                                            ? const Color(0x4D9489F5)
                                            : Colors.white,
                                    contentPadding:
                                        const EdgeInsetsDirectional.fromSTEB(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    fillColor:
                                        (_model.rgFocusNode?.hasFocus ?? false)
                                            ? const Color(0x4D9489F5)
                                            : Colors.white,
                                    contentPadding:
                                        const EdgeInsetsDirectional.fromSTEB(
