...
GoRouter createRouter(AppStateNotifier appStateNotifier, {List<NavigatorObserver>? observers}) => GoRouter(
      initialLocation: '/',
      observers: observers ?? [], // Use observers if provided, otherwise an empty list
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/addProfilePersonalInfo',
          builder: (context, params) => AddProfilePersonalInfoWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => SettingsListAddressWidget(),
        ),
        FFRoute(
          name: 'Notifications',
          path: '/notifications',
