...
import 'dashboard_responsive_model.dart';
export 'dashboard_responsive_model.dart';

class DashboardResponsiveWidget extends StatefulWidget {
  const DashboardResponsiveWidget({super.key});

  @override
  State<DashboardResponsiveWidget> createState() =>
      _DashboardResponsiveWidgetState();
}

class _DashboardResponsiveWidgetState extends State<DashboardResponsiveWidget>
    with TickerProviderStateMixin {
  late DashboardResponsiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardResponsiveModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DashboardResponsive'});
                                        ...
                                        children: [
                                          Expanded(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'DASHBOARD_RESPONSIVE_Container_fp2y5rs9_');
                                                logFirebaseEvent(
                                          ...
                                          Expanded(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'DASHBOARD_RESPONSIVE_Container_f61p46ou_');
                                                logFirebaseEvent(
                                                    'Container_set_dark_mode_settings');
                                                setDarkModeSetting(
